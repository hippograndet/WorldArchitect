 ...
 * validation schema. Mirrors server/src/services/articleMetadataFields.ts.
 * See dev-docs/future/design_article_metadata.md.
 */
const SUGGESTED_METADATA_FIELDS: Record<string, string[]> = {
