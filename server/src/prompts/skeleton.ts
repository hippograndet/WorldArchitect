export function buildSkeletonSystemPrompt(categories: string[]): string {
...
Aim for variety within each category. Let the world's tone and setting guide specificity. When you have generated at least 2 stubs per category, call submit_stubs.`;
}
