...
WorldArchitect is a local-first fiction worldbuilding app for writers, game masters, and narrative designers. It helps you grow a fictional world into a structured encyclopedia: articles, article types, version history, snapshots, exportable Markdown, and optional AI-assisted expansion.
...
- World creation wizard with configurable style settings
- Predefined article types with minimal infobox-style details
